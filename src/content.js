...
export const phoneText = <div className="text"> 
    ...
    <h4>My name is</h4> <h2 style={{color:"var(--green)", marginTop: "-10px"}} >Matthew Hamel</h2>
    ...
    <p style={{ position: "fixed", bottom: "15vh", color:"var(--yellow"}}>Press the arrows like the one below to transition through my portfolio.</p>
